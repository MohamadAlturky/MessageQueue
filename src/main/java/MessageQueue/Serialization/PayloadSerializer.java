...
/**
 * Responsible for the serialization and deserialization of message bodies.
...
public interface PayloadSerializer {
     ...
     */
    <T> T serialize(Object payload) throws SerializationException;

    /**
     * Decodes the payload from its String representation. Used on the consumer side of the queue.
     * @param payload the payload read from the message queue that is to be consumed.
